...
<div style="overflow:auto">
  ...
  <div class="main">
  <b><h3 style="font-size:25px; text-align:center";>SETTLEMENT PLAN</h3></b>
  <div class="sett">
...
if ($_POST) { // Sayfada post olup olmadığını kontrol ediyoruz.
  ...
  if (isset($_POST['list_all'])) {
    $sorgu = $conn->query("SELECT bt.idbt, bt.binaid, bt.oda, b.idb, b.bina 
                      ...
                      INNER JOIN building as b ON bt.binaid = b.idb"); // List All butonu tıklanırsa tüm verileri çekme
...
?>
    ...
    <tr>
		...
		<td><?php echo $bina; ?></td> 
    <td><?php echo $oda;  ?></td>
    <td><a href="settlementplannewper.php?id=<?php echo $id; ?>" ><input type="submit" class="btn-edit" value="NEW PERSON"></a></td>
    <td><a href="settlementplandetail.php?id=<?php echo $id; ?>" ><input type="submit" class="btn-look" value="LOOK"></a></td>
...
<td><a href="settlementplandetailstaff.php" ><input type="submit" class="btn-edit" value="STAFF QUERY"></a></td>
<td><a href="settlementplandetailprison.php" ><input type="submit" class="btn-edit" value="PRISON QUERY"></a></td>
</tr></table>
