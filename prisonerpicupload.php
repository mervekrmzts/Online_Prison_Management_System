...
$yeniad="prisonerpic/".$getid.".jpg";
unlink ($yeniad);
if (move_uploaded_file($dosya, $yeniad)){
   
    
    $sql=("UPDATE prisoners SET resim= '$yeniad' WHERE idprs =".$getid); //id değeri ile düzenlenecek verileri veritabanından alacak sorgu
    echo $getid;
    echo "<br>";
    echo $yeniad;
    echo "<br>";
...
if ($conn->query($sql) === TRUE) {
    echo "Prisoner information has been updated successfully.";
} else {
...
$conn->close();
    ...
    header("Location: prisoneredit.php?id=".$getid);
