...
$sorgu = $conn->query("SELECT h.hid, h.mahkumid, h.muayenetarihi, muayenesaati, p.ad, p.soyad FROM health as h, prisoners as p WHERE p.aktiflik='Yes' AND mahkumid='$prisonid' and h.mahkumid=p.idprs ORDER BY h.muayenetarihi, h.muayenesaati"); // health tablosundaki aktif mahkumların muayenelerini listeleme 
