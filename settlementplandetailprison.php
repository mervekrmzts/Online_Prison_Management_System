...
<div style="overflow:auto">
  ...
  <b><h3 style="font-size:25px; text-align:center";>SETTLEMENT PLAN DETAIL (PRISON)</h3></b>
  <div class="settings">
    <div class="sett">
  <form action="" method="POST">

<label for="prisoner">Prisoner:</label>
          <select id="prisoner" class="combo" name="prisoner"><!--Mahkumlar-->
          <option value="">---Select---</option>
          <?php  
          
          $query = "SELECT idprs, ad, soyad FROM prisoners WHERE aktiflik='Yes'";// Mahkum isimlerini veritabanından alma
...
$prisonid=$_POST['prisoner'];

$sorgu = $conn->query("SELECT * FROM settlement WHERE sperid='$prisonid' AND prisonstaf='P'" ); // settlememt tablosundaki ilgili verileri çekme
